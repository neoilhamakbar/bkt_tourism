...
var server = "http://13.76.171.120/bkt_tourism/souvenir_bkt/";
var map;
var markersDua = [];
var koordinat = 'null'
var infoposisi = [];
      ...
      { 
        ...
        {   
          ...
          if (jenis == 'sou') {
            ...
            $('#hasilcari').append("<tr><td>"+nama_tempat_kuliner+"</td><td><a role='button' class='btn btn-success' onclick='detsouxx(\""+id_tempat_kuliner+"\");'>Show</a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id_tempat_kuliner+"\")'></a></td></tr>");
          }
...
function kuliner_sekitar(latitude,longitude,rad){ //KULINER SEKITAR 
          ...
          $.ajax({url: server+'_sekitar_kuliner.php?lat='+latitude+'&long='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#hasilcariculi').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-danger fa fa-info' onclick='detculi(\""+id+"\")'></a></td><td><a role='button' class='btn btn-danger fa fa-road' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='kulAngkot(\""+id+"\",\""+lat+"\",\""+lon+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
