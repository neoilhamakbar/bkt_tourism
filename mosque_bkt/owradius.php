...
$querysearch="SELECT ow_id, ow_nama,ow_tiket, st_x(st_centroid(the_geom)) as lon,st_y(st_centroid(the_geom)) as lat,
	st_distancesphere(ST_GeomFromText('POINT(".$longi." ".$latit.")',-1), objek_wisata.the_geom) as jarak 
	FROM objek_wisata where st_distancesphere(ST_GeomFromText('POINT(".$longi." ".$latit.")',-1),
